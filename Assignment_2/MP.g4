...
varTypeDeclList: varTypeDecl SEMI varTypeDeclList | varTypeDecl;
...
arrayType: ARRAY LQ (ADDOP|SUBOP)? INTLIT DOUBLE_DOT (ADDOP|SUBOP)? INTLIT RQ OF primType;
...
// expr: expr1 expr_;
// expr_: ((AND THEN|OR ELSE) expr1 expr_)?;
// expr1: expr2 ((EQUAL|NOT_EQUAL|GREATER|LESS|GREATER_OR_EQUAL|LESS_OR_EQUAL) expr2)?;
// expr2: expr3 expr2_;
// expr2_: ((ADDOP|SUBOP|OR) expr3 expr2_)?;
// expr3: expr4 expr3_;
// expr3_: ((DIVOP|MULOP|DIV|MOD|AND) expr4 expr3_)?;
// expr4: (NOT|ADDOP|SUBOP)? expr5;
// expr5: LB expr RB
// 	| (INTLIT|FLOATLIT|IDENTIFIER|indexExpr|BOOLLIT|invoExpr|STRINGLIT);
...
stmtsList: stmts stmtsList|stmts;
stmts: assignStmt|callStmt|returnStmt|whileStmt|withStmt|forStmt|ifStmt|breakStmt|continueStmt;
...
forStmt: FOR (forCondition|LB forCondition RB) DO bodyIter;
